...
namespace Ntech.DisableIntrospection.Resolvers
{
    public class SharedResolvers
    {
        ...
        public double GetHeight(Unit? unit, [Parent]ICharacter character) => ConvertToUnit(character.Height, unit);

        public double GetLength(Unit? unit, [Parent]Starship starship) => ConvertToUnit(starship.Length, unit);
